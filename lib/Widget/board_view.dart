...
class _BoardViewState extends State<BoardView> {
  ...
  Size get size => Size(MediaQuery.of(context).size.width * 0.75,
      ...
      children: <Widget>[
        ...
        Container(
          ...
          decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(blurRadius: 16, color: Colors.black45.withOpacity(0.3))]
          ),
        ),
        Transform.rotate(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              gradient: LinearGradient(
                  ...
                  colors: [luck.color, luck.color.withOpacity(0.3)])),
        ),
      ),
    );
  }
    ...
    return Transform.rotate(
      ...
      child: Container(
        ...
        child: ConstrainedBox(
          constraints:
              BoxConstraints.expand(height: size.height / 3, width:MediaQuery.of(context).size.height<600?80: 90),
